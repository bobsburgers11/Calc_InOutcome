...
<div class="container">
    <div class="row">
        <h3>Nebenkostenrechnung</h3>
    </div>
    <div class="row">
        <h5>Wählen Sie den Zeitraum für den gewünschten Bericht aus und drücken sie den entsprechenden Knopf.</h5>
    </div>

         <form class="form-horizontal" action="?controller=AuxiliaryCost&action=show"  onsubmit="return validateAuxiliaryCostForm()" onkeyup="return validateAuxiliaryForm()" method="post">
            <?php include_once("formAuxiliary_Cost.php"); ?>
